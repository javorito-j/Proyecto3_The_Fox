...
// =========================
// LLAMADA A LAS FUNCIONES (ESTO ALIMENTA TU HTML)
// =========================
...
<body>
    <div class="dashboard">
        ...
        <div class="main-content">
            ...
            <div class="content-grid">
                ...
                <div>
                    <!-- Grafico iteractivo -->
                    <div class="table-container" style="margin-top: 15px; margin-bottom: 20px;">
                        <h3 class="section-title"><i class="fas fa-chart-bar"></i> Actividad Reciente</h3>
    ...
    <script>
        // === CHART.JS: CONFIGURACIÓN BÁSICA ===
        const ctx = document.getElementById('actividadChart').getContext('2d');
        let actividadChart = new Chart(ctx, {
            type: 'line',
            data: {
                labels: [], // etiquetas (se llenan con AJAX)
                datasets: [{
        ...
        // === AJAX: ACTUALIZA EL GRÁFICO CADA 10 SEGUNDOS ===
        async function actualizarGrafico() {
            try {
                ...
                if (data.labels && data.valores) {
                    actividadChart.data.labels = data.labels;
                    actividadChart.data.datasets[0].data = data.valores;
        ...
        // Actualización inicial y periódica
        actualizarGrafico();
